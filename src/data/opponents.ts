...
const RAW_TEAMS: ReadonlyArray<RawTeam> = [
  ...
  { id: "cro98", nation: "Croatia", year: 1998, tier: "C", pref: "balanced",
    ...
    squad: [
      ...
      { name: "Zvonimir Soldo", pos: "MID", overall: 77 },
      { name: "Igor Tudor", pos: "DEF", overall: 76 },
    ],
  },
  ...
  { id: "mar22", nation: "Morocco", year: 2022, tier: "C", pref: "defensive",
    ...
    squad: [
      ...
      { name: "Jawad El Yamiq", pos: "DEF", overall: 76 },
      { name: "Zakaria Aboukhlal", pos: "FWD", overall: 77 },
    ],
  },
  ...
  { id: "ned78", nation: "Netherlands", year: 1978, tier: "B", pref: "offensive",
    ...
    squad: [
      ...
      { name: "Piet Schrijvers", pos: "GK", overall: 76 },
      { name: "René van de Kerkhof", pos: "MID", overall: 79 },
      { name: "Adrie van Kraay", pos: "DEF", overall: 75 },
      { name: "Dick Nanninga", pos: "FWD", overall: 75 },
    ],
  },
  ...
  { id: "por06", nation: "Portugal", year: 2006, tier: "B", pref: "balanced",
    ...
    squad: [
      ...
      { name: "Paulo Ferreira", pos: "DEF", overall: 78 },
      { name: "Petit", pos: "MID", overall: 78 },
      { name: "Tiago", pos: "MID", overall: 78 },
      { name: "Hélder Postiga", pos: "FWD", overall: 77 },
      { name: "Nuno Gomes", pos: "FWD", overall: 79 },
    ],
  },
  ...
  { id: "bel18", nation: "Belgium", year: 2018, tier: "B", pref: "offensive",
    ...
    squad: [
      ...
      { name: "Thomas Vermaelen", pos: "DEF", overall: 79 },
      { name: "Simon Mignolet", pos: "GK", overall: 76 },
      { name: "Yannick Carrasco", pos: "MID", overall: 79 },
      { name: "Nacer Chadli", pos: "MID", overall: 77 },
      { name: "Michy Batshuayi", pos: "FWD", overall: 78 },
    ],
  },
  ...
  { id: "ned74", nation: "Netherlands", year: 1974, tier: "A", pref: "offensive",
    ...
    squad: [
      ...
      { name: "Rinus Israël", pos: "DEF", overall: 78 },
      { name: "Piet Keizer", pos: "FWD", overall: 78 },
      { name: "Theo de Jong", pos: "MID", overall: 76 },
      { name: "René van de Kerkhof", pos: "MID", overall: 78 },
      { name: "Willy van de Kerkhof", pos: "MID", overall: 77 },
    ],
  },
  ...
  { id: "hun54", nation: "Hungary", year: 1954, tier: "A", pref: "offensive",
    ...
    squad: [
      ...
      { name: "László Budai", pos: "MID", overall: 78 },
      { name: "Sándor Gellér", pos: "GK", overall: 75 },
    ],
  },
  ...
  { id: "bra82", nation: "Brazil", year: 1982, tier: "A", pref: "offensive",
    ...
    squad: [
      ...
      { name: "Edinho", pos: "DEF", overall: 79 },
      { name: "Paulo Isidoro", pos: "MID", overall: 77 },
      { name: "Batista", pos: "MID", overall: 76 },
      { name: "Roberto Dinamite", pos: "FWD", overall: 79 },
    ],
  },
  ...
  { id: "cro18", nation: "Croatia", year: 2018, tier: "A", pref: "balanced",
    ...
    squad: [
      ...
      { name: "Vedran Ćorluka", pos: "DEF", overall: 78 },
      { name: "Milan Badelj", pos: "MID", overall: 78 },
      { name: "Mateo Kovačić", pos: "MID", overall: 79 },
      { name: "Andrej Kramarić", pos: "FWD", overall: 78 },
      { name: "Marko Pjaca", pos: "FWD", overall: 76 },
    ],
  },
  ...
  { id: "bra70", nation: "Brazil", year: 1970, tier: "S", pref: "offensive",
    ...
    squad: [
      ...
      { name: "Marco Antônio", pos: "DEF", overall: 77 },
      { name: "Joel Camargo", pos: "DEF", overall: 77 },
      { name: "Paulo Cézar Caju", pos: "MID", overall: 78 },
      { name: "Edu", pos: "FWD", overall: 78 },
      { name: "Roberto Miranda", pos: "FWD", overall: 76 },
    ],
  },
  ...
  { id: "ita82", nation: "Italy", year: 1982, tier: "S", pref: "defensive",
    ...
    squad: [
      ...
      { name: "Pietro Vierchowod", pos: "DEF", overall: 78 },
      { name: "Giampiero Marini", pos: "MID", overall: 77 },
      { name: "Giuseppe Dossena", pos: "MID", overall: 75 },
      { name: "Franco Causio", pos: "MID", overall: 79 },
      { name: "Daniele Massaro", pos: "FWD", overall: 74 },
      { name: "Ivano Bordon", pos: "GK", overall: 75 },
    ],
  },
  ...
  { id: "arg86", nation: "Argentina", year: 1986, tier: "S", pref: "offensive",
    ...
    squad: [
      ...
      { name: "Néstor Clausen", pos: "DEF", overall: 77 },
      { name: "Oscar Garré", pos: "DEF", overall: 77 },
      { name: "Marcelo Trobbiani", pos: "MID", overall: 75 },
      { name: "Pedro Pasculli", pos: "FWD", overall: 76 },
    ],
  },
  ...
  { id: "fra98", nation: "France", year: 1998, tier: "S", pref: "balanced",
    ...
    squad: [
      ...
      { name: "Bernard Lama", pos: "GK", overall: 77 },
      { name: "Vincent Candela", pos: "DEF", overall: 78 },
      { name: "Christophe Dugarry", pos: "FWD", overall: 78 },
      { name: "Alain Boghossian", pos: "MID", overall: 77 },
      { name: "Bernard Diomède", pos: "MID", overall: 74 },
    ],
  },
  ...
  { id: "uru30", nation: "Uruguay", year: 1930, tier: "S", pref: "offensive",
    ...
    squad: [
      ...
      { name: "Conduelo Píriz", pos: "MID", overall: 75 },
  ...
  { id: "ita34", nation: "Italy", year: 1934, tier: "S", pref: "defensive",
    ...
    squad: [
      ...
      { name: "Luigi Bertolini", pos: "MID", overall: 77 },
      ...
      { name: "Mario Pizziolo", pos: "MID", overall: 74 },
      { name: "Pietro Arcari", pos: "FWD", overall: 75 },
    ],
  },
  ...
  { id: "ita38", nation: "Italy", year: 1938, tier: "S", pref: "defensive",
    ...
    squad: [
      ...
      { name: "Pietro Pasinati", pos: "FWD", overall: 76 },
    ],
  },
  ...
  { id: "uru50", nation: "Uruguay", year: 1950, tier: "S", pref: "offensive",
    ...
    squad: [
      ...
      { name: "Rubén Morán", pos: "FWD", overall: 76 },
      { name: "Aníbal Paz", pos: "GK", overall: 75 },
    ],
  },
  ...
  { id: "wge54", nation: "West Germany", year: 1954, tier: "S", pref: "balanced",
    ...
    squad: [
      ...
      { name: "Werner Liebrich", pos: "DEF", overall: 78 },
      { name: "Bernhard Klodt", pos: "FWD", overall: 75 },
    ],
  },
  ...
  { id: "bra58", nation: "Brazil", year: 1958, tier: "S", pref: "offensive",
    ...
    squad: [
      ...
      { name: "De Sordi", pos: "DEF", overall: 78 },
      { name: "Mauro Ramos", pos: "DEF", overall: 78 },
      { name: "Oreco", pos: "MID", overall: 77 },
      { name: "Dino Sani", pos: "MID", overall: 78 },
      { name: "Castilho", pos: "GK", overall: 76 },
    ],
  },
  ...
  { id: "bra62", nation: "Brazil", year: 1962, tier: "S", pref: "offensive",
    ...
    squad: [
      ...
      { name: "Altair", pos: "DEF", overall: 78 },
      { name: "Jair Marinho", pos: "DEF", overall: 75 },
      { name: "Zequinha", pos: "MID", overall: 76 },
      { name: "Mengálvio", pos: "MID", overall: 76 },
      { name: "Pepe", pos: "FWD", overall: 79 },
    ],
  },
  ...
  { id: "eng66", nation: "England", year: 1966, tier: "S", pref: "balanced",
    ...
    squad: [
      ...
      { name: "Jimmy Armfield", pos: "DEF", overall: 78 },
      { name: "Norman Hunter", pos: "DEF", overall: 78 },
      { name: "Ron Flowers", pos: "MID", overall: 77 },
      { name: "Terry Paine", pos: "FWD", overall: 76 },
    ],
  },
  ...
  { id: "wge74", nation: "West Germany", year: 1974, tier: "S", pref: "balanced",
    ...
    squad: [
      ...
      { name: "Horst-Dieter Höttges", pos: "DEF", overall: 78 },
      { name: "Bernhard Cullmann", pos: "MID", overall: 77 },
      { name: "Herbert Wimmer", pos: "MID", overall: 78 },
      { name: "Jürgen Grabowski", pos: "FWD", overall: 79 },
      { name: "Heinz Flohe", pos: "MID", overall: 76 },
      { name: "Wolfgang Kleff", pos: "GK", overall: 74 },
    ],
  },
  ...
  { id: "arg78", nation: "Argentina", year: 1978, tier: "S", pref: "offensive",
    ...
    squad: [
      ...
      { name: "Daniel Bertoni", pos: "FWD", overall: 79 },
      { name: "José Daniel Valencia", pos: "MID", overall: 77 },
      { name: "Ricardo Villa", pos: "MID", overall: 76 },
    ],
  },
  ...
  { id: "wge90", nation: "West Germany", year: 1990, tier: "S", pref: "defensive",
    ...
    squad: [
      ...
      { name: "Stefan Reuter", pos: "DEF", overall: 78 },
      { name: "Hans Pflügler", pos: "DEF", overall: 76 },
      { name: "Olaf Thon", pos: "MID", overall: 78 },
      { name: "Uwe Bein", pos: "MID", overall: 76 },
      { name: "Frank Mill", pos: "FWD", overall: 75 },
    ],
  },
  ...
  { id: "bra94", nation: "Brazil", year: 1994, tier: "S", pref: "balanced",
    ...
    squad: [
      ...
      { name: "Jorginho", pos: "DEF", overall: 79 },
      { name: "Aldair", pos: "DEF", overall: 84 },
      { name: "Márcio Santos", pos: "DEF", overall: 80 },
      { name: "Branco", pos: "DEF", overall: 82 },
      { name: "Dunga", pos: "MID", overall: 85 },
      ...
      { name: "Ronaldão", pos: "DEF", overall: 75 },
      { name: "Zetti", pos: "GK", overall: 76 },
      { name: "Müller", pos: "FWD", overall: 79 },
    ],
  },
