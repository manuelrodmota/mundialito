...
const TACTICAL_DESCRIPTIONS: Record<string, string> = {
  ...
  penalty: 'Penalty Kick — forces a shot this round, scoring ~78% of the time regardless of build-up. Requires ≥1 FWD.',
  ...
  handOfGod: 'Hand of God — once per match, forces a near-certain shot (~95% to score). Requires ≥1 FWD.',
