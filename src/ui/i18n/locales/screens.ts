...
export const en = {
  ...
  'screens.htpScoreBody1':
    "Each round both teams build <b>expected goals (xG)</b>. Your attackers fill <b>your</b> meter; the opponent's attackers fill <b>theirs</b>. Every time a meter fills a whole goal, that's a <span class=\"gold\">GOAL</span>.",
  'screens.htpScoreBody2':
    "Defenders and your keeper <b>slow the other side's meter</b> — they don't score, they keep goals out.",
  ...
  'screens.htpRoundStep5': '<b>Lock in</b> — both lineups reveal and the meters fill.',
...
export const es: typeof en = {
  ...
  'screens.htpScoreBody1':
    'Cada ronda ambos equipos generan <b>goles esperados (xG)</b>. Tus atacantes llenan <b>tu</b> medidor; los atacantes del rival llenan <b>el suyo</b>. Cada vez que un medidor completa un gol entero, eso es un <span class="gold">GOL</span>.',
  'screens.htpScoreBody2':
    'Los defensas y tu portero <b>frenan el medidor del rival</b> — no marcan, evitan goles.',
  ...
  'screens.htpRoundStep5': '<b>Confirma</b> — ambas alineaciones se revelan y los medidores se llenan.',
