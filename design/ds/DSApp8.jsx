...
const NAV = [
  ...
  { group: "Patterns", items: [["scoreboard", "Scoreboard & clock"], ["piles", "Card piles"], ["limits", "Hand & tactical limits"], ["extratime", "Extra time"], ["meters", "Meters & gauges"], ["lanes", "Lanes & clash"]] },
        ...
        <main className="ds-main">
          <div className="ds-wrap">
            <header className="ds-hero">
              ...
              <p>The complete visual language for the roguelike World Cup card game — built on Hiedra's purple accent, re-skinned for a dark stadium-night theme. Updated for the v8 hand &amp; tactical limits: a guaranteed five-card hand each round, a live tactical-play counter (2 a half, 4 a match), and a run tactical-deck cap that turns the reward into a swap. The v7 90-minute match carries over — numeric scoreboard, match clock, 3-goal mercy marker, bench/exiled piles and the golden-goal extra-time beat. Every token, component and pattern below renders live from the production CSS.</p>
              <div className="meta">
