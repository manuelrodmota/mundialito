// WORLD CUP CLASH — Design System: Patterns (v7 live match-board widgets)
// v7: numeric scoreboard + running match clock, 3-goal mercy marker, draw/discard/bench/exiled
// piles, and the golden-goal extra-time beat. (The old 5-ball score strip is retired.)
...
function Patterns() {
  return (
    <React.Fragment>
      ...
      {/* ============ CARD PILES ============ */}
      <Section id="piles" eyebrow="Patterns" title="Card piles — the v7 flow"
        lede="Four zones flank the hand and tell the whole story of card flow: commons cycle through draw/discard forever, premium players bench until halftime, and single-use Tactical Cards burn away to the exiled pile.">
      ...
      {/* ============ EXTRA TIME ============ */}
      <Section id="extratime" eyebrow="Patterns" title="Extra time — golden goal"
        lede="Level at full time? A distinct golden-goal mode: meters reset to 0, benched stars and fatigue refresh, every xG counts double, and the next goal wins. The board takes a warm gold cast and a banner makes the stakes unmistakable.">
        <Frame center pitch caption={<span><Code>.et-banner7</Code> over a board tinted with <Code>.et-mode</Code>; the scoreboard switches to its <Code>.scoreboard7.et</Code> palette.</span>}>
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 22 }}>
            <div className="et-banner7" style={{ position: "static", transform: "none" }}>
              ...
              <b>EXTRA TIME</b><span className="et-sep">·</span>GOLDEN GOAL<span className="et-sep">·</span>next goal wins<span className="et-sep">·</span>xG ×2
            </div>
