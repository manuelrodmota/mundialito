...
const NAV = [
  ...
  { group: "Patterns", items: [["scoreboard", "Scoreboard"], ["meters", "Meters & gauges"], ["lanes", "Lanes & clash"]] },
        ...
        <main className="ds-main">
          <div className="ds-wrap">
            <header className="ds-hero">
              <div className="kicker">Design system · v1</div>
              <h1>World Cup Clash</h1>
              <p>The complete visual language for the roguelike World Cup card game — built on Hiedra's purple accent, re-skinned for a dark stadium-night theme. Every token, component and pattern below renders live from the production CSS, so you can implement the React app against a single source of truth.</p>
              <div className="meta">
