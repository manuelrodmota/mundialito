  ...
  return (
    <React.Fragment>
        ...
        <Frame caption={<span><Code>.menu</Code> over <Code>.stadium-bg</Code> — kicker · gradient H1 · sub · gold / brand / ghost action stack.</span>}>
          <div style={{ position: "relative", width: "100%", minHeight: 360, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 28, overflow: "hidden", borderRadius: 12 }}>
            ...
            <div className="logo-block" style={{ textAlign: "center", zIndex: 1 }}>
              ...
              <div className="sub" style={{ color: "var(--txt-dim)", marginTop: 12, fontSize: 15 }}>Pick an XI. Score goals. First to three wins.</div>
            </div>
      ...
      <Section id="builder" eyebrow="Run & meta" title="Squad builder"
        lede="Build an XI under a slot budget. The slot meter tracks spend against the cap and turns red on overflow; picks list with rating, slot cost and a captain toggle. Formation picker sets your tactical lean.">
        <div className="ds-grid cols-2">
          <Tile label="Slot meter" sub="fills brand→gold; .over turns red">
            <div style={{ width: "100%", display: "flex", flexDirection: "column", gap: 20 }}>
              <div className="slot-meter">
                <div className="row"><span style={{ fontSize: 13, color: "var(--txt-dim)", fontWeight: 700 }}>SLOTS USED</span><b>9 / 12</b></div>
                <div className="track"><i style={{ width: "75%" }} /></div>
              </div>
              <div className="slot-meter">
                <div className="row"><span style={{ fontSize: 13, color: "var(--txt-dim)", fontWeight: 700 }}>OVER BUDGET</span><b className="over">14 / 12</b></div>
          ...
          <Tile label="Pick rows" sub="rating · name · slot cost · captain · remove">
            <div className="pick-rows" style={{ width: "100%" }}>
              ...
              <div className="pick-row tactic-row"><span className="rt">—</span><span className="nm">Catenaccio</span><span className="sl">1 sl</span><button className="rm">✕</button></div>
            </div>
          </Tile>
        </div>
      ...
      <Section id="inputs" eyebrow="Run & meta" title="Filters & inputs"
        ...
        <Frame caption={<span><Code>.filters</Code> row — inputs, select, range. Focus borders go <Code>--brand</Code>.</span>}>
          <div className="filters" style={{ border: "none", padding: 0, width: "100%" }}>
            ...
            <select defaultValue="all"><option value="all">All rarities</option><option>Legendary</option><option>Epic</option><option>Rare</option><option>Common</option></select>
