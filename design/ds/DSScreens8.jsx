  ...
  return (
    <React.Fragment>
      ...
      <Section id="builder" eyebrow="Run & meta" title="Squad builder"
        lede="Build an XI under a slot budget. The slot meter tracks spend against the cap and turns red on overflow; picks list with rating, slot cost and a captain toggle. The tactical tray starts at one card and grows to a run cap of ~4. Formation picker sets your tactical lean.">
