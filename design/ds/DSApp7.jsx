...
const NAV = [
  ...
  { group: "Patterns", items: [["scoreboard", "Scoreboard & clock"], ["piles", "Card piles"], ["extratime", "Extra time"], ["meters", "Meters & gauges"], ["lanes", "Lanes & clash"]] },
        ...
        <main className="ds-main">
          <div className="ds-wrap">
            <header className="ds-hero">
              <div className="kicker">Design system · v7</div>
              <h1>World Cup Clash</h1>
              <p>The complete visual language for the roguelike World Cup card game — built on Hiedra's purple accent, re-skinned for a dark stadium-night theme. Updated for the v7 90-minute match: a numeric scoreboard and match clock, the 3-goal mercy marker, bench/exiled card piles and the golden-goal extra-time beat. Every token, component and pattern below renders live from the production CSS.</p>
              <div className="meta">
