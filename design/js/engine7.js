// WORLD CUP CLASH v7 — the 90-minute match (GDD v7 §6, §8, §14, §15)
// v7 changes vs v5: full 90' (no race-to-3) → 3-goal-lead MERCY or most goals at full time;
//   golden-goal EXTRA TIME (xG ×2, meters reset) on a level full time; premium players LOCK
//   until halftime / ET (commons cycle freely); Tactical Cards are single-use (EXILED).
...
(function () {
  ...
  window.WCC7E = Object.assign({}, window.WCC3E, {
