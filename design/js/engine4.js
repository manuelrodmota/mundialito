// WORLD CUP CLASH v4 — xG engine: goals, fatigue, visible tacticals (GDD v4 §7–§14)
...
(function () {
  ...
  function startRound(state) {
    ...
    state.players.forEach((P, idx) => {
      ...
      // flat stamina — refreshes every round, no growth (GDD §6)
  ...
  function aiPlan(state) {
    ...
    // 5. Fill attack (ATK per cost), then defense (DEF per cost)
  ...
  window.WCC4E = Object.assign({}, window.WCC3E, {
