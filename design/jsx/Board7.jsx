// WORLD CUP CLASH v7 — match board: numeric scoreboard + match clock, 3-goal mercy, golden-goal
// extra time, bench (locked premium players) + exiled (single-use Tactical) piles. Engine = WCC7E.

function Board7({ squad, captainId, team, stage, tuning, motion, showIntentFormation, onWin, onRunOver, onConcede }) {
  const E = window.WCC7E;
