// WORLD CUP CLASH v8 — run shell. v8 hand & tactical limits: draw back to a 5-card minimum hand;
// at most 2 Tactical plays per half (4/match); Run tactical deck capped at ~4 (reward becomes a swap).
...
function HowToPlay5({ onClose, t }) {
  const rows = [
    ...
    ["Plan", `Draw back up to ${t.handSize || 5} each round — a guaranteed five-card hand (grays reshuffle in if your pile runs dry). Stamina ramps as the match heats up — ${t.staminaPerRound} (R1–5), ${t.staminaPerRound + 2} (R6–8), ${t.staminaPerRound + 4} (R9–10) — and you may field at most ${t.cardCapBase} players a round (rising to ${t.cardCapBase + 1}, then ${t.cardCapBase + 2}). Pick a formation, secretly field players into ATTACK or DEFENSE.`],
