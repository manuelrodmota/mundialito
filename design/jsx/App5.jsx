// WORLD CUP CLASH v5 — run shell: v5 balance knobs (stamina ramp, card cap, rarity) + how-to-play
...
function HowToPlay5({ onClose, t }) {
  const rows = [
    ...
    ["Star quality", "Rarer cards hit harder: each card contributes its stats × a rarity multiplier — rare ×1.1, epic ×1.2, legendary ×1.3. A legendary is worth the gamble."],
    ...
    ["Plan", `Draw 3 each round. Stamina ramps as the match heats up — ${t.staminaPerRound} (R1–5), ${t.staminaPerRound + 2} (R6–8), ${t.staminaPerRound + 4} (R9–10) — and you may field at most ${t.cardCapBase} players a round (rising to ${t.cardCapBase + 1}, then ${t.cardCapBase + 2}). Tactical cards don't count toward the cap. Pick a formation, secretly field players into ATTACK or DEFENSE — but tactical cards are face-up the moment they're played, by both sides.`],
